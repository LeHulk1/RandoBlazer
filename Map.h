...
enum {
    ...
    ITEM_MOUNTAIN_KING                 = 89,
    ITEM_BOY_MUSHROOM_SHOES            = 90,
    ITEM_NOME                          = 91,
    ITEM_SNAIL_EMBLEM_E                = 92,
    ITEM_EMBLEM_F                      = 93,
    ITEM_CRYSTAL_MOUNTAIN_OF_SOULS     = 94,
    ITEM_CRYSTAL_LUNE                  = 95,
    ITEM_EMBLEM_G                      = 96,
    ITEM_CHEST_OF_DRAWERS_MYSTIC_ARMOR = 97,
    ITEM_PLANT_HERB                    = 98,
    ITEM_CAT_DOOR_KEY                  = 99,
    ITEM_PLANT_ACTINIDIA_LEAVES        = 100,
    ITEM_MARIE                         = 101,
    ITEM_MOUSE_SPARK_BOMB              = 102,
    ITEM_CRYSTAL_LEOS_LAB_BASEMENT     = 103,
    ITEM_CRYSTAL_MODEL_TOWN            = 104,
    ITEM_CRYSTAL_POWER_PLANT           = 105,
    ITEM_SOLDIER_ELEMENTAL_MAIL        = 106,
    ITEM_SUPER_BRACELET                = 107,
    ITEM_QUEEN_MAGRIDD                 = 108,
    ITEM_SOLDIER_PLATINUM_CARD         = 109,
    ITEM_MAID_HERB                     = 110,
    ITEM_EMBLEM_H                      = 111,
    ITEM_KING_MAGRIDD                  = 112,
    ITEM_DR_LEO                        = 113,
    ITEM_HARP_STRING                   = 114,
    ITEM_MERMAID_HERB                  = 115,
    ITEM_MERMAID_BUBBLE_ARMOR          = 116,
    ITEM_MERMAID_MAGIC_FLARE           = 117,
    ITEM_MERMAID_QUEEN                 = 118,
    ITEM_MERMAID_RED_HOT_STICK         = 119,
    ITEM_LUE                           = 120,
